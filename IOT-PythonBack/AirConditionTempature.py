...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        ...
        current_data='Aircondition sensor: Temperature: '+str(temp)+' Humidity: '+str(hum)
        self.connectionDock.Temperature.setText(str(temp))
        self.connectionDock.Humidity.setText(str(hum))
        if(self.starting_tempeture > air_condition_limit):
            self.mc.publish_to(comm_topic,"Its too Hot above 30 degrees, Active air condition")
            self.down_back=-2
        else:
