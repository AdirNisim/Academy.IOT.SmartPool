...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePushtbtn.setToolTip("People Movement")
    ...
    def push_button_click(self):
        self.mc.publish_to(self.ePublisherTopic.text(), 'Lights , Movement detected active lights!')
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('LightMovment sensor')
