      ...
      viewModel.eventsStatus.observe(this) {
            when (it.status) {
                ...
                is Success -> {
                    ...
                    binding.temptureSwitch.isChecked = it.status.data!![1].service_status == 1
                    binding.LightsSwitch.isChecked = it.status.data!![2].service_status == 1
                    when(it.status.data!![3].service_status){
                        1 -> {
                            ...
                            messageTextView.text = it.status.data!![3].service_description.toString()
